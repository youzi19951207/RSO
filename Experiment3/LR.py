...
for NUM_KEY in range(2 , 32, 2):

 
        #===============文件夹设置===================
        CH=np.load("../data/#64_b64_100000_challenge_"+str(NUM_KEY)+"XOR.npy")
        #RSP=np.load('G:/Data/Data64_error/#1_b64_100000_response_10%.npy').transpose()
        RSP=np.load("../data/#64_b64_100000_response_"+str(NUM_KEY)+"XOR.npy")
                ...
                with tf.Session(graph=g):
                    ...
                    for step in range(10000):
                        ...
                        if step %50==0:
                            ...
                            if a < 0.1:
                                break
                            #print('经过%d轮训练准确率为：' % (int(step) / 50 + 1), a)
                        # if (a>=0.95):
                        #     break;
        ...
        np.save("../data/data_XOR"+str(NUM_KEY), ans_f)

np.save("../data/data_XOR", ans_f)